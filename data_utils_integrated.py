...
def prep_msd_data_ray(combined_files:pd.DataFrame,dest:str,w1:int,w2:int,run_date:str,run_id:str)->None:
    ...
    # base = os.path.join(cwd,dest,cur_date)
    # num_runs = "run_" + str(len(next(os.walk(base))[1]) + 1)
    path = os.path.join(cwd,dest,run_date,run_id)
    ...
    # Craete the destination filepaths
    evaluate_root = os.path.join(path,"evaluate")
    predict_root = os.path.join(path,"predict")
    ...
    # sources
    data_train_path = os.path.join(train_root,"sources")
    data_val_path = os.path.join(predict_root,"source")
    data_test_path = os.path.join(evaluate_root,"sources")

    display_train_path = os.path.join(train_root,"display")
    display_val_path = os.path.join(predict_root,"display")
    display_test_path = os.path.join(evaluate_root,"display")
    # masks
    seg_train_path = os.path.join(train_root,"masks")
    seg_val_path = os.path.join(predict_root,"masks")
    seg_test_path = os.path.join(evaluate_root,"masks")

    weight_train_path = os.path.join(train_root,"weights")
    weight_val_path = os.path.join(predict_root,"weights")
    weight_test_path = os.path.join(evaluate_root,"weights")
    ###########################
    # Implementation Footnote #
    ###########################
